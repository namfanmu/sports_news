...
public class PublicVideoNewsController extends HttpServlet {
	...
	public PublicVideoNewsController() {
		super();
		catsDAO = new CatsDAO();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		int count = newsDAO.countAllVideoNews();
		int pageSize = 4;
		int endPage = 0;
		...
		ArrayList<News> videoNewsList = newsDAO.getAllVideoNewsPaging(index, pageSize);
		...
		request.getRequestDispatcher("/public/pages/video.jsp").forward(request, response);
	}
