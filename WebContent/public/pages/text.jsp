						...
						<div class="card" data-aos="fade-up">
							<div class="card-body">
								<div class="row">
									...
									%>
									<h2 style="padding-left: 20px; font-weight: bold; color: blue;">TIN
										TỨC</h2>
								</div>
								<div class="row">
									<div class="col-lg-8">
										...
										<%
											...
											%>
											<a href="<%=request.getContextPath()%>/index/text?index=<%=index - 1%>">&laquo;</a>
											<%	
											}
											...
											%>
											<a class="<%if(i == index) out.print("active"); %>" href="<%=request.getContextPath()%>/index/text?index=<%=i%>"><%=i%></a>
											<%
											}
											%>
											<%
											...
											%>
											<a href="<%=request.getContextPath()%>/index/text?index=<%=index + 1%>">&raquo;</a>
											<%
											}
											%>
										</div>
									...
									<div class="col-lg-4">
										<div class="trending">
											...
											<div class="mb-4">
												...
												ArrayList<News> allMostViewTextNewsList = newsDAO.getAllMostViewTextNews();
												for (News mostViewTextNews : allMostViewTextNewsList) {
												%>
												<div style="margin-bottom: 30px; border-bottom: solid 1px;">
													<div class="rotate-img">
														<img
															src="<%=request.getContextPath()%>/files/<%=mostViewTextNews.getImage()%>"
															alt="banner" class="img-fluid"
															style="height: 175px; width: 310px;" />
													</div>
													<h3 class="mt-3 font-weight-600">
														<a
															href="<%=request.getContextPath()%>/index/detail?id=<%=mostViewTextNews.getId()%>&index=1"
															title="<%=mostViewTextNews.getTitle()%> "
															style="text-decoration: none;"><%=mostViewTextNews.getTitle()%></a>
													</h3>
													<p class="fs-13 text-muted mb-0">
														<span class="mr-2">Ngày đăng: <%=mostViewTextNews.getCreated_date()%></span>
													</p>
												</div>
												<%
												}
