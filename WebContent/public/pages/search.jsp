					...
					<div class="col-sm-12">
						<div class="card" data-aos="fade-up">
							<div class="card-body">
								<div class="row">
									<%
									ArrayList<News> searchedNewsList = (ArrayList<News>) request.getAttribute("searchedNewsList");
									String txtSearch = (String) request.getAttribute("txtSearch");
									%>
									<div class="col-sm-12">
										<h3 class="font-weight-600 mb-4" style="color: blue;">
											Hiển thị tất cả các kết quả cho "<span style="color: red"><%=txtSearch%></span>"
										</h3>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-8">
											...
											<div class="col-sm-4 grid-margin">
												<div class="rotate-img">
													<img
														...
														alt="banner" class="img-fluid" style="height: 150px; width: 195px;" />
												</div>
											</div>
										...
										<%
											...
											%>
											<a class="<%if(i == index) out.print("active"); %>" href="<%=request.getContextPath()%>/index/search?index=<%=i%>&txtSearch=<%=txtSearch%>"><%=i%></a>
											<%
											}
											%>
											<%
												...
												<div class="border-bottom pb-4 pt-4">
													<div class="row" style="margin-top: -30px">
														...
														<div class="col-sm-8" style="height: 120px">
															<h5 class="font-weight-600 mb-1"><a
										...
										<div class="trending">
											...
											<div class="mb-4">
												...
												<div style="margin-bottom: 30px; border-bottom: solid 1px;">
													...
													<h3 class="mt-3 font-weight-600"><a
