				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header">
							...
							if("1".equals(msg)){
				        		out.print("<span style='color: blue;font-weight: bold;' >Thêm mới danh mục tin tức thành công!</span>");
				        	}
							if("2".equals(msg)){
				        		out.print("<span style='color: blue;font-weight: bold;' >Chỉnh sửa danh mục tin tức thành công!</span>");
				        	}
							if("3".equals(msg)){
				        		out.print("<span style='color: blue;font-weight: bold;' >Xóa danh mục tin tức thành công!</span>");
				        	}
							...
							%>
							<h3 class="card-title">Danh sách Danh mục Tin tức</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								%>
									<tr>
										...
										<td class="center"><%=footballCats.getName() %> - Bóng đá</td>
										<td class="center">
                                            <a href="<%=request.getContextPath() %>/admin/cats/edit?id=<%=footballCats.getId() %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="<%=request.getContextPath() %>/admin/cats/delete?id=<%=footballCats.getId() %>" title="" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><i class="fas fa-trash"></i> Xóa</a>
                                        </td>
									</tr>
								<%
										}
								...
								%>
									<tr>
										<td class="center"><%=index %></td>
										<td class="center"><%=tennisCats.getName() %> - Quần vợt</td>
										<td class="center">
                                            <a href="<%=request.getContextPath() %>/admin/cats/edit?id=<%=tennisCats.getId() %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="<%=request.getContextPath() %>/admin/cats/delete?id=<%=tennisCats.getId() %>" title="" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><i class="fas fa-trash"></i> Xóa</a>
                                        </td>
									</tr>
								<%
										}
