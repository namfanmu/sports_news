...
<body>
	...
	out.print("checked");%>>
							...
							<div class="form-group">
								<label for="exampleInputTitle">Tên danh mục tin tức</label> <input
									type="text" class="form-control" id="exampleInputTitle"
									placeholder="" name="name"
									value="<%if (footballCats != null) {
	out.print(footballCats.getName());
} else if (tennisCats != null)
	out.print(tennisCats.getName());%>">
							</div>
