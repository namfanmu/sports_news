				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header">
							...
							if("1".equals(msg)){
				        		out.print("<span style='color: blue;font-weight: bold;' >Thêm mới tin tức thành công!</span>");
				        	}
							if("2".equals(msg)){
				        		out.print("<span style='color: blue;font-weight: bold;' >Chỉnh sửa tin tức thành công!</span>");
				        	}
							if("3".equals(msg)){
							...
							<table id="example1" class="table table-bordered table-striped">
								...
								%>
									<tr>
                                        ...
                                        %>
										<td class="center">
                                            <a href="<%=request.getContextPath() %>/admin/news/edit?id=<%=news.getId() %>" title="" class="btn btn-primary"><i class="fa fa-edit "></i> Sửa</a>
                                            <a href="<%=request.getContextPath() %>/admin/news/delete?id=<%=news.getId() %>" title="" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><i class="fas fa-trash"></i> Xóa</a>
                                        </td>
                                        <%
